"""Unit tests for nsty.utils.break_calculation.get_break_minutes.

Pure-logic tests — no Frappe DB needed. Run with:
    python -m unittest nsty.utils.test_break_calculation
or via bench:
    bench --site <site> run-tests --module nsty.utils.test_break_calculation
"""

import unittest
from datetime import date, datetime, time

from nsty.utils.break_calculation import get_break_minutes
