"""Nightly scheduler tasks for the nsty app.

Currently:
    sweep_stale_ins() -- daily 10:00 AM job that tags Employee Checkin
    IN logs older than STALE_HOURS hours without a matching OUT as
    is_abandoned=1, and pings HR Manager(s) with a count.
"""
