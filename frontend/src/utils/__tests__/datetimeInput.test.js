...
test("Frappe datetime -> datetime-local input", () => {
	assert.equal(toDatetimeLocal("2026-09-23 14:05:00"), "2026-09-23T14:05")
	assert.equal(toDatetimeLocal("2026-09-23 08:30:59.123456"), "2026-09-23T08:30")
	assert.equal(toDatetimeLocal("2026-09-23 08:30"), "2026-09-23T08:30")
})
...
test("round trip keeps the minute", () => {
	...
	assert.equal(toDatetimeLocal(fromDatetimeLocal("2026-09-23T07:45")), "2026-09-23T07:45")
})
