<template>
	<GPage>
		<ion-content :fullscreen="true">
			...
			/>
			<ResourceError :resource="formFields" back what="the shift assignment form" />
		</ion-content>
	</GPage>
</template>
...
// validateDates() below reads this — was never injected, so picking an end
// date before the start date threw ReferenceError instead of showing the
// friendly message.
