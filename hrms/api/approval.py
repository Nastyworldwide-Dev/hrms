...
DECIDE_THEN_SUBMIT = {
	...
	# Nabil, 15 Sep 2026: "yes add that reject button". Submitting used to BE
	# approving, so the approver could not decline. Its on_submit grants the
	# Leave Allocation days only when Approved, like the three above.
