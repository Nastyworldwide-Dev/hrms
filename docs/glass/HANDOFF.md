...
commit:   e82a82ffd on nz-glass (reviewed DEPLOY; pushed)
...
next:     Nabil deploys → Provenance Audit Recover → Day Audit Repair → one hourly run → HR amends any leftover day (it now stays); then claims setup + rulings Q1–Q6
